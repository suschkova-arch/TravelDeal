    ...
    <div style={{ maxWidth: 1000, margin: '0 auto' }}>
      <div style={{ textAlign: 'center', marginBottom: 40 }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: 16, maxWidth: 640, margin: '0 auto' }}>
          Железнодорожные маршруты по России и ближним направлениям — удобно, комфортно и выгоднее перелёта на средних дистанциях.
        </p>
      </div>
      ...
      >
        <strong style={{ color: '#fff' }}>Совет путешественнику:</strong> после прибытия на вокзал удобно забронировать отель через Яндекс Путешествия, квартиру посуточно через Sutochno или Avito, а взять авто на месте — через Localrent для самостоятельных маршрутов.
      </div>
    </div>
  </section>
);
